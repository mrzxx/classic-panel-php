...
$blog_tr = $db->query("SELECT * FROM blog WHERE langid=0", PDO::FETCH_ASSOC);
    ...
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="finput">
                        ...
                        <div class="finput">
                            <label for="title2">Blog Dili</label>
                        ...
                        <input type="hidden" name="operation" value="blog,ekle">
                        <input type="submit" name="submitted" value="BLOG EKLE" class="btn d-grid btn-danger text-white">
                    </form>
                </div>
            </div>
            ...
            <?php
                ...
                $project = $db->query("SELECT * FROM blog WHERE id='{$editid}'")->fetch(PDO::FETCH_ASSOC);
                if($project){
                    $_SESSION["editid"] = $project["id"];
                    ?>
                    <p class="text-muted">Blog DÜZENLE <code></code></p>
                    <div class="row">
                    <div class="col-md-8">
                    <form enctype="multipart/form-data" style="padding-top:15px;" action="<?php echo $siplink.'operations.php'; ?>" method="POST">
                    <div class="finput">
                        ...
                        <div class="finput">
                            ...
                            <?php if($project["img"] != ""){ ?>
                                    <img id="anaresim" width="180" src="<?php echo $mainlink.'assets/img/blog/'.$project['img']; ?>" alt=""/>
                                    <a class="anaresimsil" style="display:block;margin-top:10px;color:red;" id="<?php echo $project["id"]; ?>&anaresimsil=3&table=blog" href="#">AnaResim Sil (X)</a>
                                    <?php
                                } ?>
                        </div>
                        <div class="finput">
                        ...
                        <input type="hidden" name="operation" value="blog,duzenle">
                        <input type="submit" name="submitted" value="BLOG DÜZENLE" class="btn d-grid btn-danger text-white">
                    </form>
                    </div>
                </div>
                    <?php
            ...
            <div class="table-responsive">
                <table id="table_id">
                    ...
                    <tbody>
                        ...
                        $rows = $db->query("SELECT * FROM blog ORDER BY id",PDO::FETCH_ASSOC);
                        if(1==1){
                            foreach ($rows as $row) {
                                ?>
                                <tr class="trow">
                                    ...
                                    <td>
                                        <img width="80" src="<?php echo $webfile.'img/blog/'.$row["img"]; ?>" alt="">
                                    ...
                                    <td><a class="btn btn-primary" href="<?php echo $siplink.'blog?target=edit12412&editid='.$row["id"] ?>">Düzenle</a>
                                        <a class="btn btn-warning delbutton" id="<?php echo $row["id"]; ?>&table=blog" href="#">Sil [X]</a></td>
                                </tr>
                                <?php
                                }
                        }
